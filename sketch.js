...
// PLEASE HELP ME I WANT TO MAKE THE APPLE DISPPEAR WHEN THE RABBIT TOUCHES IT .
if (apple.isTouching(rabbit)){ 
appleHit(rabbit,appleImg);
}

 
function appleHit(rabbit,apple) {
 appleImg.remove();
}
